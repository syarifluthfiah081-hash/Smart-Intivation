  ...
  return (
    <div className="w-full bg-white select-none relative group">
      ...
      <div className="flex items-center justify-between gap-3 text-black font-serif">
        ...
        <div className="w-[72px] h-[72px] min-w-[72px] max-w-[72px] max-h-[72px] flex-shrink-0 flex items-center justify-center bg-white overflow-hidden">
        ...
        <div className="flex-1 text-center px-1 font-serif">
          ...
          <h3 className="text-[14px] md:text-[15px] uppercase font-bold leading-tight tracking-normal mt-0.5 text-black">
            {data.schoolName || 'SMK NEGERI 2 KOTA TIDORE KEPULAUAN'}
          </h3>
          <p className="text-[10.5px] leading-tight mt-0.5 font-normal text-black font-serif">
